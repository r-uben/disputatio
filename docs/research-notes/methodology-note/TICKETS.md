...
| 6 | Pattern: auditable disposition trail | **pending** | methodology-section-writer | none | `briefs/06_disposition_trail.md` | `sections/06_disposition_trail.md` | shortest section (~500 words) |
...
| 8 | Adopt-and-adapt guide | **pending** | methodology-section-writer | none (benefits from §§5-7 settling but not blocked) | `briefs/08_adopt_adapt_guide.md` | `sections/08_adopt_adapt_guide.md` | most creative section; the actual "researchers can fork this" payoff |
