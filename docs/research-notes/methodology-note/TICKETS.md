...
| 5 | Pattern: archetype-driven literature engagement | **pending** | methodology-section-writer | none | `briefs/05_lit_engagement.md` | `sections/05_lit_engagement.md` | exemplar — validates the brief+subagent format |
| 6 | Pattern: auditable disposition trail | **pending** | methodology-section-writer | brief still to write | `briefs/06_disposition_trail.md` (TODO) | `sections/06_disposition_trail.md` | shortest section (~500 words) |
...
| 8 | Adopt-and-adapt guide | **pending** | methodology-section-writer | brief still to write; benefits from §§5-7 settling | `briefs/08_adopt_adapt_guide.md` (TODO) | `sections/08_adopt_adapt_guide.md` | most creative section; the actual "researchers can fork this" payoff |
